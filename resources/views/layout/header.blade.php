			...
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
                        @if(Auth::check())
						<li><a href="{{ route('cake.listcart', Auth::user()->id)}}"><i class="fa fa-user"></i>Giỏ Hàng</a></li>
                        <li><a href="{{ route('cake.listproducthead', Auth::user()->id)}}"><i class="fa fa-user"></i>Yêu thích</a></li>

                        <li><a href="/logout">Xin Chào {{Auth::user()->full_name }}</a></li>
						...
						<div class="cart">
                            ...
                            @foreach($product_cart as $product)
								<div class="cart-item">
									...
									<div class="media">
										<a class="pull-left" href="#"><img src="/product/{{ $product['item']['image'] }}" alt=""></a>
                            ...
                            @endif
								...
								<div class="cart-caption">
									...
									<div class="center">
										<div class="space10">&nbsp;</div>
										<a href="/dat_hang" class="beta-btn primary text-center">Đặt hàng <i class="fa fa-chevron-right"></i></a>
									</div>
                                    @endif
								</div>
							</div>
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="#">Sản phẩm</a>
							...
							<ul class="sub-menu">
                                @foreach($loai_sp as $type_product)
								    <li><a href=" /cake/loai_san_pham/{{$type_product->id}} " > {{ $type_product->name }} </a></li>
                                @endforeach
							</ul>

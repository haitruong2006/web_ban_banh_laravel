...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 12, 2022 lúc 04:48 AM
...
CREATE TABLE `bills` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1: Chờ giao hàng\r\n2: Đang giao hàng\r\n3: Đã giao hàng',
...
INSERT INTO `bills` (`id`, `id_customer`, `name`, `address`, `phone`, `date_order`, `total`, `payment`, `note`, `status`, `created_at`, `updated_at`) VALUES
(57, 50, 'tran viet thai', 'da nang', '0123456789', '2022-11-03', 70000, 'COD', NULL, 1, '2022-11-03 06:20:21', '2022-11-03 06:20:21'),
(56, 50, 'tran viet thai', 'da nang', '0123456789', '2022-11-03', 160000, 'COD', NULL, 1, '2022-11-03 06:18:49', '2022-11-03 06:18:49');
...
(81, 56, 2, 1, 160000, '2022-11-03 06:18:49', '2022-11-03 06:18:49'),
(82, 57, 25, 1, 70000, '2022-11-03 06:20:21', '2022-11-03 06:20:21');
...
CREATE TABLE `discount` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1: chưa sử dụng\r\n2: đã sử dụng\r\n\r\n'
...
INSERT INTO `discount` (`id`, `name`, `price`, `status`) VALUES
(1, 'hello', 100000, 1),
(2, 'giam200k', 200000, 1);
...
CREATE TABLE `users` (
  ...
  `level` tinyint(11) NOT NULL DEFAULT 2,
...
INSERT INTO `users` (`id`, `full_name`, `gender`, `email`, `password`, `phone`, `address`, `level`, `remember_token`, `created_at`, `updated_at`) VALUES
(38, 'ngô văn hải trường', 'nam', 'truongngo.050902@gmail.com', '$2y$10$jTJtHcW.mkH0JjElvf0jge7.tAec3UvFjW81JOEufuk0ksUyIE.iO', '0373705810', 'quảng nam', 1, NULL, NULL, NULL),
(41, 'Nguyễn Văn AN', 'nam', 'kuankevin240802@gmail.com', '$2y$10$H.SB0Rvgb4HaRfa4w.UxBO1rJw9ygqf9gK732sD4uwp1LljJ10gLK', '0123456789', 'Biện Bàn QUảng Nảm', 2, NULL, NULL, NULL),
(50, 'tran viet thai', 'nam', 'truong@gmail.com', '$2y$10$h/W5.u8Ps7OIvle9TL/7oukbVW9oE51nFJSinnRRnUbZPnRbJK/bC', '0123456789', 'da nang', 2, NULL, NULL, NULL),
(53, 'ngô văn hải trường', 'nam', '20c0142@danavtc.edu.vn', '$2y$10$jTJtHcW.mkH0JjElvf0jge7.tAec3UvFjW81JOEufuk0ksUyIE.iO', '0123456789', 'quảng nam', 2, NULL, NULL, NULL);
